...
def create_client_classification_images(data_dir, exp_dir, users=1, client_id=0, classification_label_portion=0.6, total_classification_data=800):
    ...
    total_train_dir = data_dir+'/train_fl/'
...
if round!=0:
    ...
    average_model_checkpoint_path = transfer_model_path#'/home/dsv/maul8511/distributed_ml_project/experiment_dir_users_1_rounds_1_local_epochs_15_accuracy_std_dev_0.6_0.1_15_1_0/best_model_0.pth'
    model.load_state_dict(torch.load(average_model_checkpoint_path, map_location=device))
