...
#CUDA_VISIBLE_DEVICES=0 python3 run_clients.py covid_xray jsrt.mat CovidMix_fd_client_zeus.py 9 5 5 .6 .1 10 1 0 accuracy std_dev&>> log_user_9_std_dev.txt &
...
exp_dir = 'exp_global_dir_'+'users_'+str(users)+'_'+'rounds_' + str(rounds)+'_'+'local_epochs_' + str(local_epochs)+'_' +performance_metric+'_'+weight_averaging
