...
#CUDA_VISIBLE_DEVICES=2 python3 run_clients_transfer.py covid_xray_transfer jsrt.mat CovidMix_fd_client_zeus_transfer.py 1 1 2 .6 .1 15 1 0 accuracy weighted_metric&>> log_transfer_2.txt &
...
exp_dir = 'exp_transfer_dir_global_epochs_' + str(local_epochs)+'_' +performance_metric
